...
/**
* @see Intrabuild_Mail_Protocol_Pop3
*/
require_once 'Intrabuild/Mail/Protocol/Pop3.php';
 ...
 * bug gets released.
 *
 * The class uses Intrabuild_Mail_Protocol_Pop3 as the default driver for
 * POP3 connections
 */
class Intrabuild_Mail_Storage_Pop3 extends Zend_Mail_Storage_Pop3 {
    ...
    public function __construct($params)
    {
        ...
        if ($params instanceof Intrabuild_Mail_Protocol_Pop3) {
        ...
        $this->_protocol = new Intrabuild_Mail_Protocol_Pop3();

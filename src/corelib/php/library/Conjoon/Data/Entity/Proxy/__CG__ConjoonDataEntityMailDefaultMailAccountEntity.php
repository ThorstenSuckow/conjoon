    ...
    implements \Doctrine\ORM\Proxy\Proxy, \Conjoon\Data\Entity\EntityProxy
{
    ...
    public function addFolderMapping(\Conjoon\Data\Entity\Mail\FolderMappingEntity $folderMapping)
    {
        $this->__load();
        return parent::addFolderMapping($folderMapping);
    }

    public function removeFolderMapping(\Conjoon\Data\Entity\Mail\FolderMappingEntity $folderMapping)
    {
        $this->__load();
        return parent::removeFolderMapping($folderMapping);
    }

    public function getFolderMappings()
    {
        $this->__load();
        return parent::getFolderMappings();
    }

    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'name', 'address',
            'replyAddress', 'isStandard', 'protocol', 'serverInbox',
            'serverOutbox', 'usernameInbox', 'usernameOutbox',
            'userName', 'isOutboxAuth', 'passwordInbox',
            'passwordOutbox', 'signature', 'isSignatureUsed',
            'portInbox', 'portOutbox', 'inboxConnectionType',
            'outboxConnectionType', 'isCopyLeftOnServer', 'isDeleted', 'user',
            'folderMappings'
        );
    }

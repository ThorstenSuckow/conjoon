...
/**
 * Exception to be thrown whenever an operation on two folders is to be executed
 * which do not share the same exact meta information.
 *
 * @category   Conjoon
 * @package    Exception
 *
 ...
 */
class FolderMetaInfoMismatchException

 ...
 */
class TagWhiteSpaceRemoverTest extends \PHPUnit_Framework_TestCase {
    ...
    {
        $this->_transformer = new TagWhiteSpaceRemover();

        $this->_inputs = array(
            "<test>   jkjjkjk </test>     <text> </text>"
            => "<test>   jkjjkjk </test><text></text>",
            "<test>   jkjj<a mailto='joesmith' /> kjk </test>     <text> </text>"
            => "<test>   jkjj<a mailto='joesmith' /> kjk </test><text></text>"
        );

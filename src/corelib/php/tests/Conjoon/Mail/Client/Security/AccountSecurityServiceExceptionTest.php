 ...
 */
require_once 'Conjoon/Mail/Client/Security/AccountSecurityServiceException.php';
 ...
 */
class AccountSecurityServiceExceptionTest extends \PHPUnit_Framework_TestCase {

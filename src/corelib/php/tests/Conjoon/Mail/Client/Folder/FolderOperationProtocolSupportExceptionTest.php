...
/**
 * @see Conjoon\Mail\Client\Folder\FolderOperationProtocolSupportException
 */
 ...
 */
class FolderOperationProtocolSupportExceptionTest extends \PHPUnit_Framework_TestCase {

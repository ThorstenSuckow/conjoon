                ...
                new Ext.BoxComponent({
                    autoEl : {
                        ...
                        html : '<div class="info"><span class="bold">'+name+"</span><br />"+edition+" <br />"+version +
                               '<div class="about">'+
                                 '(c) 2007-2009 <a href="http://www.conjoon.org" target="_blank">conjoon.org'+'</a><br />'+
                                 String.format(
                                    com.conjoon.Gettext.gettext("conjoon uses libraries which are intellectual property of their respective owners.<br />Fore more information, visit <a href='{0}'>{0}</a>."),

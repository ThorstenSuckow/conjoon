 ...
 */
Ext.defineClass('conjoon.mail.comp.folderPanel.FolderMenu', {
    ...
    initComponent : function() {
        ...
        if (!me.folderService ||
            !(me.folderService instanceof conjoon.mail.comp.folderPanel.compModel.FolderService)) {
        ...
        conjoon.mail.comp.folderPanel.FolderMenu.superclass.initComponent.call(me);
    },
...
// -------- API
     ...
     * this instance
     *
     * @return {conjoon.mail.comp.folderPanel.listener.FolderMenuListener}
     */
    getFolderMenuListener : function() {
        ...
        if (!me.folderMenuListener) {
            me.folderMenuListener = Ext.createInstance(
                'conjoon.mail.comp.folderPanel.listener.FolderMenuListener', {
                    menu : me,

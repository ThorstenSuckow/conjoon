 ...
 * Install chunk_2
 *
 * Takes care of patching - warming up
 *
...
include('./scripts/check_auth.php');
    ...
    InstallLogger::stdout(InstallLogger::logMessage("Warming up..."));
    ...
    if (isset($_SESSION['patches'])) {
     ...
     echo "<script type=\"text/javascript\">this.location.href=\"./index.php?action=install_chunk_3\"</script>";
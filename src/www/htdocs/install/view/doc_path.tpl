...
<p>
 conjoon does not necessary be installed in the document root of your webserver, and can be accessed
 from any folder that is within your server's document root.<br />

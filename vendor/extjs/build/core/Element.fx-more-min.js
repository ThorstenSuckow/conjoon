...
me.removeClass([XMASKED,XMASKEDRELATIVE]);},isMasked:function(){return this.mask&&this.mask.isVisible();},createShim:function(){var el=document.createElement('iframe'),shim;el.frameBorder='0';el.className='ext-shim';if(Ext.isIE&&Ext.isSecure){el.src=Ext.SSL_SECURE_URL;}
